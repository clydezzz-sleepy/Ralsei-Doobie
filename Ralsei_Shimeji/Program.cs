...
namespace WinRalseiShimeji
{
    ...
    {
        public static List<Form1> RalseiInstances = new List<Form1>();
    ...
    public partial class Form1 : Form
    {
        ...
        private readonly static List<Form1> ralseiObj;
        ...
        private static bool 
            = false;
        ...
        public Form1()
        {
            ...
            COOLpuffTimer.Tick += (s, e) =>
            {
                ...
                PointF chosenPos = COOLpuffPositions[index];
                PointF scaledPos = new PointF(
                    this.Left + chosenPos.X * ralseiScale,
                    this.Top + chosenPos.Y * ralseiScale
                );
                smokeParticles.Add(new SmokeParticle(scaledPos, COOLpuffImage, PuffType.Cool)); // Relative to Ralsei
                COOLpuffTimer.Interval = rand.Next(500, 2000);
            };
            COOLpuffTimer.Start();

            UNCOOLpuffTimer = new Timer();
            UNCOOLpuffTimer.Interval = rand.Next(3000, 6000); // Less frequent
            UNCOOLpuffTimer.Tick += (s, e) =>
            {
                ...
                PointF chosenPos = UNCOOLpuffPositions[index];
                PointF scaledPos = new PointF(
                    this.Left + chosenPos.X * ralseiScale,
                    this.Top + chosenPos.Y * ralseiScale
                );
                smokeParticles.Add(new SmokeParticle(scaledPos, UNCOOLpuffImage, PuffType.Cool));

                UNCOOLpuffTimer.Interval = rand.Next(3000, 6000);
            };
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            foreach (var puff in smokeParticles)
            {
                ...
                Rectangle destRect = new Rectangle((int)puff.Position.X, (int)puff.Position.Y, width, height);
        ...
        public static void SpawnRalsei()
        {
            ...
            if (RalseiManager.RalseiInstances.Count >= 5 &&
                !)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                     = true;
                }
                else
                {
                    return; // Cancel spawn
